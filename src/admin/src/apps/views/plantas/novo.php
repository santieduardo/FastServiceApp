<h4 class="page-header">Plantas - <small>Cadastrar</small></h4>
...
<form action="<?=site_url('plantas/novo'); ?>" method="post" id="plantas-form">
	<div class="row">
		<div class="col-md-12 col-md-offset-0">
					...
					<select name="id_cliente" class="form-control" required="required">
						...
						<?php
							foreach($clientes as $cliente){
								if(post('id_cliente') == $cliente->id_cliente){
			...
			<div class="row">
				<div class="col-md-6 form-group">
					...
					<input type="text" maxlength="100" required="required" class="form-control" name="ide" value="<?=post('ide'); ?>">
				</div>
				
				<div class="col-md-6 form-group">
					<label>CGC *</label>
					<input type="text" maxlength="100" required="required" class="form-control" name="cgc" value="<?=post('cgc'); ?>">
				</div>
			...
			<div class="row">
				...
				<div class="col-md-4 form-group">
					<label>Bairro *</label>
					<input type="text" maxlength="75" required="required" class="form-control" name="bairro" value="<?=post('bairro'); ?>">
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-3 form-group">
					<label>CEP *</label>
					<input type="text" maxlength="75" required="required" class="form-control mask-cep" name="cep" value="<?=post('cep'); ?>">
				</div>
				...
				<div class="col-md-3 form-group">
					<label>Cidade *</label>
					<input type="text" maxlength="150" required="required" class="form-control" name="cidade" value="<?=post('cidade'); ?>">
				</div>
				
				<div class="col-md-3 form-group">
					<label>Telefone *</label>
					<input type="text" maxlength="150" required="required" class="form-control" name="tel" value="<?=post('tel'); ?>">
				</div>
			</div>
